...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    email.current.value = "chins@example.com";
    password.current.value = "Chins99";
    try{
      const authDetail = {
        email: email.current.value,
        password: password.current.value
