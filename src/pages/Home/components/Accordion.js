...
export const Accordion = ({faq}) => {
  ...
  return (
    ...
    <button onClick={() => setShow(!show)} type="button" className="text-lg flex items-center justify-between w-full py-5 font-medium text-left
     ...
     data-accordion-target="#accordion-flush-body-1" aria-expanded="true" aria-controls="accordion-flush-body-1">
            ...
            { show && <i className="bi bi-chevron-up"></i>} 
        </button>
    </h2>     
    { show && (
